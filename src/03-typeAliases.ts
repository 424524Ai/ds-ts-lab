...
function makeBuddyList(
    ...
    return {
        name, members: buddies, administrator: admin,
    } as BuddyList;
...
function getBuddyListriends(list: BuddyList): Friend[] {
...
console.log("Friends in footballbuddies are: \n")
console.log(getBuddyListriends(myFootballBuddies))
console.log("Friends in band buddies are: \n")
console.log(getBuddyListriends(myBandBuddies))
